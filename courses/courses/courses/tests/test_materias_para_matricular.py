...
from courses.courses.models import Course, CourseGroup, Schedule
from courses.courses.queries import list_by_enrolling_courses
from courses.users.models import Teacher, Student
